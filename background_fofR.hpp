									   ...
									   const int fofR_type)
{
	...
	R1 = func_RK_Rdot(a, H, R, 3. * Hconf(a, fourpiG, cosmo) * Hconf(a, fourpiG, cosmo), fourpiG, params, fofR_type);
									 ...
									 const int fofR_type)
{
	...
	R1 = dtau * func_RK_Rdot(a, H, R, 3. * Hconf(a, fourpiG, cosmo) * Hconf(a, fourpiG, cosmo), fourpiG, params, fofR_type);
